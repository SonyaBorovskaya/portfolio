<div class="col-md-6">
	<a href="admin.php" type="button" class="btn btn-outline-secondary" style="margin-top: -48px;">Вернуться назад</a>
	<form action="admin.php?do=save" method="post">
		<div class="card mt-4">
			...
			<div class="card-body">
				<div>
					<label for="title" class="form-label">ID курса</label>
					<input type="text" name="title" id="title" class="form-control">
				</div>
				<div>
					<label for="title" class="form-label">Название теста</label>
					<input type="text" name="curse_id" id="curse_id" class="form-control">
				</div>
						...
						<div class="mt-4">
							...
							<div class="answers">
								...
								<div class="text-center mt-4">
									<button type="button" class="btn btn-light border addAnswer" data-question="1"
										data-answer="1">Добавить вариант ответа</button>
								</div>
							</div>
						</div>
					</div>
